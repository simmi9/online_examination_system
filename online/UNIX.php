...
include "back.js";
*/?>
<a href="logout.php"> <center><FONT color="#FFFFFF">logout</FONT></center> </a>
<form action='UNIXRESULT.php' method="post">
<table border=3>
            <tr>
...
$query="select * from questions  where SUB_ID='IS1'";

//$res=$db->query($query);
$res=mysql_query($query);
$q1="INSERT INTO `online`.`result` (`SUBCODE`) VALUES ('IS1')";
$r1=mysql_query($q1);
if(!$res)
